	...
	<div id="auth">
		...
		<div class="row h-100">
			...
			<div class="col-lg-5 col-12">
				...
				<div id="auth-right">
					<div class="auth-logo">
						<a href="index.html"><img src="assets/images/logo.png" alt="Logo"> LES</a>  
					</div>
					...
					<form action="" method="POST">
                        ...
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit">Send Link</button>
					</form>
