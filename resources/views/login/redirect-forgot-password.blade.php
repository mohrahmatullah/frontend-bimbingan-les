...
<html lang="en">
  <head>
	...
	<title>Reset Password - Les</title>
				...
				<div id="auth-right">
					...
					<form action="" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-xl" name="password" placeholder="New Password">
                        ...
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit">Update</button>
					</form>
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>Remember your account? <a href="{{ route('get-auth') }}" class="font-bold">Log in</a>.
                        </p>
                    </div>
				</div>
			</div>
